...
public class AddEditTaskActivity extends AppCompatActivity {
    ...
    private void initViews() {
        ...
        dateView = (TextView) findViewById(R.id.clndate);
    ...
    private void populateUI(TaskEntry task) {
        ...
        dateView.setText(task.getTododate());
    ...
    public void onSaveButtonClicked() {
        ...
        String tododate = dateView.getText().toString();
        Date date = new Date();
        TaskEntry todo = new TaskEntry(description, priority,tododate, date);
        if(mTaskId == DEFAULT_TASK_ID)
